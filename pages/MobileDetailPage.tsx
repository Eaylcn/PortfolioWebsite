...
const MobileDetailPage: React.FC = () => {
   ...
   const hasLinks = links.appStore || links.playStore || links.github;
                     ...
                     <div className="flex-1 text-center md:text-left space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                           {hasLinks ? (
                              <>
                                 {links.appStore && (
                                    <a href={links.appStore} target="_blank" rel="noopener noreferrer" className="bg-white text-background-dark px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg flex items-center gap-3 hover:scale-105 transition-transform group">
                                 ...
                                 {links.playStore && (
                                    <a href={links.playStore} target="_blank" rel="noopener noreferrer" className="bg-primary text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg flex items-center gap-3 hover:scale-105 transition-transform group">
                              ...
                              <div className="flex flex-col sm:flex-row items-center gap-4 bg-background-dark/50 p-4 rounded-3xl border border-white/5 backdrop-blur-sm">
                                 ...
                                 <p className="text-[9px] text-slate-500 italic max-w-[200px]">This application is distributed through private channels.</p>
                              </div>
                           )}
                        </div>
                     </div>
                  ...
                  <div className="p-10 md:p-16 grid lg:grid-cols-2 gap-16 border-t border-white/5">
                     <div className="space-y-10">
                        <section className="space-y-4">
                           ...
                           <p className="text-slate-400 leading-relaxed italic font-light">{project.long_description}</p>
                        </section>
