    ...
    const chapters: Chapter[] = [
        {
            ...
            achievement: "First Game Created",
            achievementIcon: "sports_esports"
        },
        {
            id: 2,
            title: "The Training",
            subtitle: "Forging the Foundation",
            years: "2015 — 2021",
            icon: "school",
            ...
            achievement: "Software Engineering Degree",
            achievementIcon: "workspace_premium"
        },
        {
            id: 3,
            title: "The QA Forge",
            ...
            achievement: "QA Mastery Unlocked",
            achievementIcon: "verified"
        },
        {
            id: 4,
            title: "The Trial",
            subtitle: "Crisis Into Opportunity",
            years: "2024",
            ...
            achievement: "Resilience Forged",
            achievementIcon: "diamond"
        },
        {
            id: 5,
            title: "The Arsenal",
            subtitle: "Building the Legacy",
            years: "2024 — Present",
            icon: "construction",
            ...
            achievement: "Multi-Project Launch",
            achievementIcon: "rocket_launch"
        }
    ];
                ...
                <div className="relative">
                                ...
                                <div className="bg-card-dark border border-border-dark rounded-3xl p-6 sm:p-8 hover:border-primary/50 transition-all group-hover:-translate-y-1">
                                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                                        ...
                                        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider shrink-0">
                                            <span className="material-symbols-outlined text-sm">{chapter.achievementIcon}</span>
                                            {chapter.achievement}
                                        </div>
                                    </div>
                    ...
                    <div className="relative pl-12 sm:pl-20 mt-12">
                        ...
                        <div className="pt-2">
                            ...
                            <p className="text-slate-500 text-sm mt-1">The quest for the next chapter awaits.</p>
                        </div>
                    </div>
                </div>
