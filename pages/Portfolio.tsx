      ...
      <div className="flex flex-wrap gap-4 justify-center mb-16 relative">
        {categories.map(cat => (
          <button
            ...
            className={`flex h-16 items-center gap-4 rounded-[1.5rem] px-8 transition-all duration-500 font-black text-sm uppercase tracking-widest relative overflow-hidden group ${
